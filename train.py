...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data',help='path to training dataset', default="./data/train")
    parser.add_argument('--valid_data',help='path to validation dataset', default="./data/test")
